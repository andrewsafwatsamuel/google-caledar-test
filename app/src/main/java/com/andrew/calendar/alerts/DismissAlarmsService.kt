...
import com.andrew.calendar.alerts.GlobalDismissManager.AlarmId
...
class DismissAlarmsService : IntentService("DismissAlarmsService") {
    ...
    companion object {
        ...
        const val SHOW_ACTION = "com.andrew.calendar.SHOW"
        const val DISMISS_ACTION = "com.andrew.calendar.DISMISS"
