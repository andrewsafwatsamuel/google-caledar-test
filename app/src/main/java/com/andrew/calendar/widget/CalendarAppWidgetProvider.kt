 ...
 */
package com.andrew.calendar.widget
...
import com.andrew.calendar.AllInOneActivity
import com.andrew.calendar.EventInfoActivity
import com.andrew.calendar.R
...
class CalendarAppWidgetProvider : AppWidgetProvider() {
    ...
    private fun performUpdate(
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            launchCalendarIntent.setClass(context, com.andrew.calendar.AllInOneActivity::class.java)
            launchCalendarIntent
                .setData(Uri.parse("content://com.andrew.calendar/time/$millis"))
    ...
    companion object {
        ...
        const val EXTRA_EVENT_IDS = "com.andrew.calendar.EXTRA_EVENT_IDS"
        ...
        @JvmStatic fun getLaunchPendingIntentTemplate(context: Context?): PendingIntent {
            ...
            launchIntent.setClass(context as Context, com.andrew.calendar.AllInOneActivity::class.java)
        ...
        @JvmStatic fun getLaunchFillInIntent(
            ...
            var dataString = "content://com.andrew.calendar/events"
            if (id != 0L) {
                ...
                fillInIntent.setClass(context as Context, com.andrew.calendar.AllInOneActivity::class.java)
            }
