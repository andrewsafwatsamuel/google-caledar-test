...
import com.andrew.calendar.alerts.AlertReceiver
import com.andrew.calendar.timezonepicker.TimeZoneInfo
import com.andrew.calendar.timezonepicker.TimeZonePickerDialog
import com.andrew.calendar.timezonepicker.TimeZonePickerDialog.OnTimeZoneSetListener
import com.andrew.calendar.timezonepicker.TimeZonePickerUtils
...
class GeneralPreferences : PreferenceFragment(), OnSharedPreferenceChangeListener,
    ...
    var mTzPickerUtils: com.andrew.calendar.timezonepicker.TimeZonePickerUtils? = null
    ...
    override fun onCreate(icicle: Bundle?) {
        ...
        if (mTzPickerUtils == null) {
            mTzPickerUtils = com.andrew.calendar.timezonepicker.TimeZonePickerUtils(getActivity())
        }
        ...
        val tzpd: com.andrew.calendar.timezonepicker.TimeZonePickerDialog = activity.getFragmentManager()
                .findFragmentByTag(FRAG_TAG_TIME_ZONE_PICKER) as com.andrew.calendar.timezonepicker.TimeZonePickerDialog
        if (tzpd != null) {
    ...
    private fun showTimezoneDialog() {
        ...
        val b = Bundle()
        b.putLong(com.andrew.calendar.timezonepicker.TimeZonePickerDialog.BUNDLE_START_TIME_MILLIS, System.currentTimeMillis())
        b.putString(com.andrew.calendar.timezonepicker.TimeZonePickerDialog.BUNDLE_TIME_ZONE, Utils.getTimeZone(activity, null))
        val fm: FragmentManager = getActivity().getFragmentManager()
        var tzpd: com.andrew.calendar.timezonepicker.TimeZonePickerDialog? = fm
                .findFragmentByTag(FRAG_TAG_TIME_ZONE_PICKER) as com.andrew.calendar.timezonepicker.TimeZonePickerDialog
        if (tzpd != null) {
            tzpd.dismiss()
        }
        tzpd = com.andrew.calendar.timezonepicker.TimeZonePickerDialog()
        tzpd.setArguments(b)
        tzpd.setOnTimeZoneSetListener(this)
    ...
    @Override
    override fun onTimeZoneSet(tzi: com.andrew.calendar.timezonepicker.TimeZoneInfo) {
        if (mTzPickerUtils == null) {
            mTzPickerUtils = com.andrew.calendar.timezonepicker.TimeZonePickerUtils(getActivity())
        }
    ...
    companion object {
        ...
        const val SHARED_PREFS_NAME = "com.andrew.calendar_preferences"
        const val SHARED_PREFS_NAME_NO_BACKUP = "com.andrew.calendar_preferences_no_backup"
